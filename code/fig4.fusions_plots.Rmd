...
(high confidence fusions, with atleast one coding gene partner, recur at least twice within dataset)
```{r}
FusJ <- read.csv("~/data/fusion_results/for_nayanga/at_least_one_fusion_gene_are_coding_1249x2896.csv", check.names = FALSE, row.names = 1)
...
FusJ4 <- FusJ3[FusJ3$Freq >=2, ] #171 fusions
```
...
write.csv(FusJ.1, "~/Analysis23_Fusions/HighConf_ProteinCoding_Rec2_171fusions.csv")
